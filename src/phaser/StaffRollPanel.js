...
export class StaffRollPanel extends Phaser.GameObjects.Container {
    constructor(scene) {
        ...
        var thanksLabelStyle = { fontSize: "10px", fontFamily: "Orbitron, Arial", fill: "#ffff00", align: "center", stroke: "#000000", strokeThickness: 2, resolution: 4 };
        var thanksNameStyle = { fontSize: "9px", fontFamily: "Orbitron, Arial", fill: "#ffffff", align: "center", stroke: "#000000", strokeThickness: 2, resolution: 4 };
