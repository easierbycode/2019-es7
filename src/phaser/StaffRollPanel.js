...
export class StaffRollPanel extends Phaser.GameObjects.Container {
    constructor(scene) {
        ...
        var thanksLabelStyle = { fontSize: "12px", fontFamily: "Orbitron, Arial", fill: "#ffff00", align: "center", stroke: "#000000", strokeThickness: 1, resolution: 8 };
        var thanksNameStyle = { fontSize: "11px", fontFamily: "Orbitron, Arial", fill: "#ffffff", align: "center", stroke: "#000000", strokeThickness: 1, resolution: 8 };
